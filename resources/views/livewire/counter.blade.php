<div class='flex items-center justify-center min-h-screen from-red-100 via-red-300 to-blue-500 bg-gradient-to-br'>
	<div class="p-4 items-center justify-center w-[680px] rounded-xl group sm:flex space-x-6 bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
		...
		<div class="sm:w-8/12 pl-0 p-5">
			<div class="space-y-2 mb-3">
				...
				<div class="flex items-center space-x-4 justify-between">
					...
					<div class="flex flex-row space-x-1">
						<button
							wire:click="adddislike" class="bg-red-500 shadow-lg shadow- shadow-red-600 text-white cursor-pointer px-3 py-1 text-center justify-center items-center rounded-xl flex space-x-2 flex-row">
						...
						<button
							wire:click="addlike" class="bg-green-500 shadow-lg shadow- shadow-green-600 text-white cursor-pointer px-3 text-center justify-center items-center py-1 rounded-xl flex space-x-2 flex-row">
            ...
            <input type="text" wire:model="message" class="mr-4 mb-3 w-full rounded border bg-gray-100 p-2 focus:border-blue-500 focus:outline-none">
            <p>{{ $message }}</p>
		</div>
	</div>  
</div>
